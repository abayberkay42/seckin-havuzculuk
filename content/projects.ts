...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: '2024',
    overview: {
      tr: '3×6×1.50 m havuzun sıfırdan yapımı. Gizli savak ve şelale ile ıslak zeminli, ferah bir alan; bej traverten kenar mermerleri ve havuz başında betona şekil verilerek oluşturulan saksılarla bütünlük sağlandı.',
      en: 'A 3×6×1.50 m pool built from scratch. A wet-deck, airy space with a hidden weir and a waterfall; unified by beige travertine coping and planters shaped in poured concrete along the poolside.',
    },
    duration: { tr: '6 hafta', en: '6 weeks' },
    area: '3×6 m',
    galleryCount: 5,
    ...
    timeline: [
      { date: { tr: 'Kazı & Kabuk', en: 'Dig & Shell' }, title: { tr: 'Kazı & Kabuk', en: 'Excavation & Shell' }, desc: { tr: 'Kazı yapıldı; betonarme kabuk ve gizli savak inşa edildi.', en: 'Excavated; the reinforced shell and hidden weir were built.' } },
